...
import styles from './SpoPeoplePicker.module.scss';
import { ISpoPeoplePickerProps } from './ISpoPeoplePickerProps';
...
import {
  ...
  SharePointUserPersona } from '../models/SpoPeoplePicker';
...
export default class SpoPeoplePicker extends React.Component<ISpoPeoplePickerProps, {}> {
  ...
  public render(): React.ReactElement<ISpoPeoplePickerProps> {
